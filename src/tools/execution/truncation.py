"""
Output truncation utility for tool results.

Prevents context explosion by truncating large outputs
and saving full content to disk for later retrieval.
"""
...
# Output directory for truncated content
...
def truncate_output(
    ...
    removed = total_bytes - current_bytes if hit_bytes else len(lines) - len(result_lines)
